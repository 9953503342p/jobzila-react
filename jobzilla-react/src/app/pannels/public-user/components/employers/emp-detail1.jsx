...
console.log('asdvfh', userId)
  useEffect(() => {
    const fetchEmployer = async () => {
      try {
        const response = await fetch(`${process.env.url}/employers/${userId}`);
        if (!response.ok) {
                    ...
                    <div className="twm-employer-self-info">
                      <div className="twm-employer-self-top">
                        <div className="twm-media-bg">
                          <img
                            src={`${process.env.url}/${employer?.backgroundbannerlogo}`} // Display employer cover image
                            alt="Cover"
                        ...
                        <div className="twm-mid-content">
                          <div className="twm-media">
                            <img
                              src={`${process.env.url}/${employer?.companylogo}`} // Display employer profile image
                              alt="Profile"
                            />
                          </div>
