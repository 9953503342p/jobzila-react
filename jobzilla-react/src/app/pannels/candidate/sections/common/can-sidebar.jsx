...
function CanSidebarSection() {
    ...
    useEffect(() => {
        const fetchProfileImage = async () => {
            try {
                ...
                if (candidateId) {
                    const response = await fetch(`${process.env.url}/get-candidate-profileimage`, {
                        method: "GET",
                        credentials: "include",
                    });
    ...
    const handleFileChange = (event) => {
        ...
        if (file && candidateId) {
            ...
            fetch(`${process.env.url}/update-candidate-profileimage`, {
                method: "POST",
                body: formData,
                credentials: "include",
            })
      ...
      const [candidateData, setCandidateData] = useState(null);
        ...
        useEffect(() => {
          const fetchCandidateData = async () => {
            try {
              const response = await fetch(`${process.env.url}/candidates`, {
                method: 'GET',
                credentials: 'include', 
                headers: {
    ...
    return (
        <>
            <div className="twm-candidate-profile-pic">
                ...
                <img
                src={`${process.env.url}/${profileImage || "assets/default-profile-image.jpg"}`}
