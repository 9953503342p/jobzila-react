...
function SectionCandidateRecentApplications() {
       ...
       useEffect(() => {
         ...
         fetch(`${process.env.url}/user/last-5appliedccompany-jobs`, {
           method: 'GET',
           credentials: 'include',
           headers: {
       ...
       const handleDeleteJob = (applyId) => {
        ...
        fetch(`${process.env.url}/apply/delete`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
                                ...
                                <div className="twm-dash-candidates-list">
                                    <div className="twm-media">
                                        <div className="twm-media-pic">
                                            ...
                                            <img src={`${process.env.url}/${job.companylogo}` || "default-logo.jpg"} alt={job.companyName} />
                                        </div>
                                    </div>
                                        ...
                                        <div className="twm-fot-content">
                                            ...
                                            <div className="twm-right-btn">
                                                <ul className="twm-controls-icon list-unstyled">
                                                  <a href={`${process.env.url}/job-detail/${job.jobId}`}>  <li>
