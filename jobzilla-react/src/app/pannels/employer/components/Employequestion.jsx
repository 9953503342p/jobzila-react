...
function Employequestion() {
  ...
  useEffect(() => {
    ...
    const fetchApplication = async () => {
      try {
        const response = await fetch(`${process.env.url}/apply-candidate-detail/${_id}`, {
          method: 'GET',
          headers: {
        ...
        <div className="card p-4">
                ...
                {qa.video && qa.video.path && (
                  <div className="mt-3">
                    ...
                    <video width="320" height="240" controls className="d-block mt-2">
                      <source src={`${process.env.url}/${qa.video.path.replace(/\\/g, '/')}`} type="video/mp4" />
          ...
          {application.resume ? (
            <div className="embed-responsive embed-responsive-16by9">
              <embed
                src={`${process.env.url}/${application.resume}`}
