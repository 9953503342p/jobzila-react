...
function EmpCompanyProfilePage() {
  ...
  const [imagePath, setImagePath] = useState('');
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch(`${process.env.url}/update-employor-info`, {
          method: "POST",
          body: form,
...
const socialMediaLinksemployer = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.url}/update-employer-socialmedia`, {
        method: 'POST',
        credentials: 'include',
        headers: {
  ...
  const handleSubmit1 = async (e) => {
    ...
    try {
      setUploading(true);
      const response = await fetch(`${process.env.url}/update-employer-videogallery`, {
        method: 'POST',
        body: formData,
  ...
  const handleFileUpload3 = async (file) => {
    ...
    try {
      const response = await fetch(`${process.env.url}/upload-gallery`, {
        method: 'POST',
        body: formData,
          ...
          <div className="row">
            ...
            <div className="col-lg-12 col-md-12">
              <div className="custome-video-upload form-group">
                ...
                <DropzoneComponent
                  config={{
                    postUrl: `${process.env.url}/update-employer-videogallery`,
                  }}
                  eventHandlers={{
                    addedfile: (file) => {
