...
function EmpDashboardPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.url}/employer-recent-activity`, {
      method: 'GET',
      headers: {
      ...
      useEffect(() => {
        ...
        const fetchApplications = async () => {
          try {
            const response = await fetch(`${process.env.url}/employer-last-application`, {
              method: 'GET',
      ...
      useEffect(() => {
        const fetchStats = async () => {
          try {
            const response = await fetch(`${process.env.url}/employer-stats`, {
              method: 'GET',
              credentials: 'include', 
            });
      ...
      useEffect(() => {
        const fetchEmployerData = async () => {
          try {
            const response = await fetch(`${process.env.url}/emploercandidate1`, {
              method: 'GET',
